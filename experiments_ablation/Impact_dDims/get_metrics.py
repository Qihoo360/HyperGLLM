...
####"test_dir_paramS48HY4_d128/@30000"
fold = "test_dir_paramS48HY4_d128/@30000"
...
####"test_dir_paramS48HY4_d256/@30000"
fold = "test_dir_paramS48HY4_d256/@30000"
with open(os.path.join(fold, "results_file.txt"), "r", encoding="utf-8") as file:
    data = json.load(file)
    ground = data["ground"]
    predict = data["predict"]
...
####"test_dir_paramS48HY4_d384/@30000"
fold = "test_dir_paramS48HY4_d384/@30000"
with open(os.path.join(fold, "results_file.txt"), "r", encoding="utf-8") as file:
    data = json.load(file)
    ground = data["ground"]
    predict = data["predict"]
...
####"test_dir_paramS48HY4_d640/@30000"
fold = "test_dir_paramS48HY4_d640/@30000"
with open(os.path.join(fold, "results_file.txt"), "r", encoding="utf-8") as file:
    data = json.load(file)
    ground = data["ground"]
    predict = data["predict"]
