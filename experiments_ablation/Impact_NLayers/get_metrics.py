...
####"test_dir_paramS48HY1/@30000"
fold = "test_dir_paramS48HY1/@30000"
...
####"test_dir_paramS48HY2/@30000"
fold = "test_dir_paramS48HY2/@30000"
with open(os.path.join(fold, "results_file.txt"), "r", encoding="utf-8") as file:
    data = json.load(file)
    ground = data["ground"]
    predict = data["predict"]
...
####"test_dir_paramS48HY3/@30000"
fold = "test_dir_paramS48HY3/@30000"
with open(os.path.join(fold, "results_file.txt"), "r", encoding="utf-8") as file:
    data = json.load(file)
    ground = data["ground"]
    predict = data["predict"]
...
####"test_dir_paramS48HY5/@30000"
fold = "test_dir_paramS48HY5/@30000"
with open(os.path.join(fold, "results_file.txt"), "r", encoding="utf-8") as file:
    data = json.load(file)
    ground = data["ground"]
    predict = data["predict"]
